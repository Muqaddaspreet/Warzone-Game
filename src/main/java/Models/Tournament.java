...
public class Tournament implements Serializable {
    ...
    public boolean parseTournamentCommand(GameState p_gameState, String p_operation, String p_argument,
                                          GameEngineController p_gameEngine) throws InvalidMap, InvalidCommand {
     ...
     */
    private boolean processNoOfTurnArguments(String p_argument, GameEngineController p_gameEngine) {
        ...
        if (l_maxTurns >= 10 && l_maxTurns <= 50) {
            ...
            p_gameEngine.setD_gameEngineControllerLog(
     ...
     * @throws InvalidMap returned if map given in command is invalid
     */
    private boolean processNoOfGameArgument(String p_argument, GameEngineController p_gameEngine) throws InvalidMap {
     ...
     */
    private boolean processStrategyArguments(GameState p_gameState, String p_argument, GameEngineController p_gameEngine) {
        ...
        for (String l_chosenStrategy : l_listofplayerstrategies) {
            ...
            if (!Constants.TOURNAMENT_PLAYER_BEHAVIORS.contains(l_chosenStrategy)) {
                p_gameEngine.setD_gameEngineControllerLog(
     ...
     */
    private void setTournamentPlayers(GameEngineController p_gameEngine, String[] p_playerStrategiesList,
     ...
     * @throws InvalidMap returned if map given in command is invalid
     */
    private boolean processMapArguments(String p_argument, GameEngineController p_gameEngine) throws InvalidMap {
        ...
        if (l_mapFilesSize >= 1 & l_mapFilesSize <= 5) {
            for (String l_mapToLoad : l_listOfMapFiles) {
                ...
                if (l_loadedMap.Validate()) {
                    ...
                    p_gameEngine.setD_gameEngineControllerLog(l_mapToLoad + " has been loaded to start the game",
                            Constants.ORDER_EFFECT);
    ...
    public boolean mandatoryTournamentArgPresent(List<Map<String, String>> p_operations_list, Command p_command) {
        ...
        for (Map<String, String> l_map : p_operations_list) {
            if (p_command.checkRequiredKeysPresent(Constants.ARGUMENTS, l_map)
                ...
                l_argumentKey.concat(l_map.get(Constants.OPERATION));
            }
        }
