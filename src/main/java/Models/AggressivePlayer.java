 ...
 * armies, launches attacks from his most powerful territory, and strategically places
 * armies to strengthen his position in a specific country.
 *
...
public class AggressivePlayer extends PlayerBehaviorStrategy {
    ...
    public String generateCardOrder(Player p_player, GameState p_gameState, String p_cardName) {
        ...
        else if ("negotiate".equals(p_cardName)) {
