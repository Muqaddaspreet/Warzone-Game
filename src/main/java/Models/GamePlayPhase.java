...
public abstract class GamePlayPhase implements Serializable {
    ...
    /**
     * d_gameEngineController manage the state of the game engine and control gameplay.
     */
    ...
    /**
     * Create instance of tournament mode.
     */
     ...
     *                        engine instance.
     */
    public GamePlayPhase(GameEngineController p_gameEngineController, GameState p_gameState) {
    ...
    public void commandHandler(String p_userInputCommand, Player p_player)
        ...
        d_gameState.updateLogFile(l_command.getD_command() + " 1", Constants.HANDLE_COMMAND);
    ...
    /**
     * InitPhase() is called when phase is being changed.
     *
    ...
    public void LogInvalidCommandInCurrentPhase() {
        d_gameEngineController.setD_gameEngineControllerLog("Invalid Command in Current State",
