...
public class DiplomacyTest {
    ...
    @Before
    public void setup() {
        d_sourcePlayer = new Player("Player1");
    ...
    public void testAdvancePostNegotiation() {
        ...
        assertEquals(d_gameState.getLog().trim(),
                "Log: Advance Command cannot be executed as Player:Player2 negotiated terms with Player:Player1");
    }
    ...
    public void testBombPostNegotiation() {
        ...
        assertEquals(d_gameState.getLog().trim(),
                "Log: Bomb Command cannot be executed as Player:Player2 negotiated terms with Player:Player1");
    }
